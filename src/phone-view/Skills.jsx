  ...
  return (
    ...
    <section className="flex flex-col px-8 gap-5 h-auto w-full">
      ...
      <div className="flex justify-center">
        <div className="w-fit grid grid-flow-row gap-8 py-1 max-[400px]:grid-cols-1 max-md:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 ">
          {mySkills.map((icon) => (
            <a
