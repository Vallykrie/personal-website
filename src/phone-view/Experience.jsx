  ...
  return (
    <section className="w-auto h-auto flex gap-5 flex-col">
      ...
      <div className="py-5 justify-center flex flex-row gap-4 h-fit items-start text-4xl text-white max-md:text-[40px] max-sm:text-3xl">
        ...
        <div className="sora-800">Experience</div>
      </div>
          ...
          >
            <div className="flex  justify-between  items-start flex-row w-full max-md:flex-col max-md:gap-2">
              <div className="flex items-center flex-row gap-8">
                ...
                <div className=" sora-600 text-2xl text-white max-md:text-xl">
                  {icon.role}
                </div>
              </div>
              <div className="mt-2 max-md:text-xs sora-400 text-base text-white flex justify-end items-center max-md:justify-start">
                {icon.date}
              </div>
            </div>
